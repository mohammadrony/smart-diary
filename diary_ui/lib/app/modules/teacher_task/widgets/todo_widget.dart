...
import 'package:diary_ui/app/modules/teacher_task/controllers/teacher_task_controller.dart';
import 'package:flutter/material.dart';
import 'package:get/get_state_manager/get_state_manager.dart';

class TodoWidget extends GetView<TeacherTaskController> {
            ...
            child: ExpansionTile(
              title: Row(
                children: [
                  ...
                  Spacer(),
                  GetBuilder<TeacherTaskController>(builder: (_) {
                    return TextButton(
                      onPressed: () async {
